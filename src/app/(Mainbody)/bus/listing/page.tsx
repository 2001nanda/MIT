...
const ListView: FC = () => {
  ...
  return (
    <CustomLayout title="inner-page overlay-black" userBgClass="user user-light" >
      {/* <Breadcrumb title="Home" subTitle="holiday package4" bannerImg={"/assets/images/inner-pages/breadcrumb1.jpg"} animation={true} class1="parallax-img pt-0" class2=" overlay-black" /> */}
